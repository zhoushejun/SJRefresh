...
@property (nonatomic, strong) UIImageView *imgv_animationBG;

@property (nonatomic, assign) BOOL bl_showGif;
@property (nonatomic, strong) NSMutableArray *idle_images;
@property (nonatomic, strong) NSMutableArray *refresh_images;
